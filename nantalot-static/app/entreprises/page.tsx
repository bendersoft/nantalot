	...
	return (
		<main style={{ fontFamily: "Arial, sans-serif" }}>
			<TextSection
				...
				content={
					<>
						Offrez à votre équipe une expérience unique avec nos balades en
						bateau spécialement conçues pour les entreprises. Renforcez les
						liens entre collègues tout en profitant d&apos;un moment de détente
						sur l&apos;eau.
					</>
				}
			/>
			...
			<TextSection
				...
				content={
					<>
						Pour organiser une sortie en bateau pour votre entreprise,
						n&apos;hésitez pas à nous contacter. Nous serons ravis de vous aider
						à planifier une expérience inoubliable.
					</>
				}
			/>
